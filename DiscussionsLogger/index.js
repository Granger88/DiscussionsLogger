                        ...
                        if (isJSON(str)) {
                            ...
                            if (posts.indexOf(data.id) == -1) {
                                if (this.eventNames().indexOf('newPost') != -1) { // Allowing clients to bind their own update event. [TODO]
                                    /**
                                     * @event newPost An event that allows for binding to send custom messages. Binding to this event will not run the original event!
                                     * @
                                     */
